...
import tdoubleking.test.item.ItemCheeseArmor;
...
public class TestMod {
	...
	public void preInit(FMLPreInitializationEvent event){
		...
		//Creating Armour
		cheeseHelmet = new ItemCheeseArmor(cheeseArmorMaterial, 0, 0).setUnlocalizedName("ItemCheeseHelmet").setTextureName("tm:helmet").setCreativeTab(tabTestMod);
		cheeseChestplate = new ItemCheeseArmor(cheeseArmorMaterial, 0, 1).setUnlocalizedName("ItemCheeseChestplate").setTextureName("tm:chestplate").setCreativeTab(tabTestMod);
		cheeseLeggings = new ItemCheeseArmor(cheeseArmorMaterial, 0, 2).setUnlocalizedName("ItemCheeseLeggings").setTextureName("tm:leggings").setCreativeTab(tabTestMod);
		cheeseBoots = new ItemCheeseArmor(cheeseArmorMaterial, 0, 3).setUnlocalizedName("ItemCheeseBoots").setTextureName("tm:boots").setCreativeTab(tabTestMod);
